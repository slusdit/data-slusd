...
const GradeDistribution2: React.FC<GradeDistributionProps> = ({ data: initialData }) => {
  ...
  const chartOptions = useMemo(() => ({
    ...
    series: [
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'A%', yName: 'A%', stacked: true, },
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'B%', yName: 'B%', stacked: true, },
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'C%', yName: 'C%', stacked: true, },
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'D%', yName: 'D%', stacked: true, },
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'F%', yName: 'F%', stacked: true, },
      { type: 'bar', xKey: 'TE', xName: 'Teacher', yKey: 'Other_Percent', yName: 'Other %', stacked: true, }
    ],
    axes: [
      {
        type: 'category',
